...
- Node.js 18+ is required (GitHub Actions use Node 18, and pnpm requires Node 18.12+)
...
- `pnpm install` -- Install dependencies. Takes ~19 seconds. 
...
- **pnpm requires Node.js 18.12+** -- Ensure you're using Node.js 18 or higher
- Current Node 20+ works fine for development
...
- Package installation: ~19 seconds
...
- **Node 18** specified in CI workflows
...
2. **Use pnpm as package manager** (requires Node.js 18.12+)
